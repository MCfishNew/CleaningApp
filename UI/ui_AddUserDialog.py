...
################################################################################
## Form generated from reading UI file 'AddUserDialoguEtouY.ui'
##
...
class Ui_AddUserDialog(object):
    def setupUi(self, AddUserDialog):
        ...
        self.new_password_input.setSizeAdjustPolicy(QAbstractScrollArea.SizeAdjustPolicy.AdjustIgnored)
        ...
        self.change_user_button.setStyleSheet(u"background-color: rgb(255, 248, 246);")
    ...
    def retranslateUi(self, AddUserDialog):
        ...
        self.new_role_input.setItemText(2, QCoreApplication.translate("AddUserDialog", u"staff", None))
        self.new_role_input.setItemText(3, QCoreApplication.translate("AddUserDialog", u"manager", None))
