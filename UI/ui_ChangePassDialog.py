...
################################################################################
## Form generated from reading UI file 'ChangePassDialogOJjKte.ui'
##
...
class Ui_ChangePassDialog(object):
    def setupUi(self, ChangePassDialog):
        ...
        ChangePassDialog.resize(301, 277)
        ...
        self.change_pass_button.setStyleSheet(u"background-color: rgb(255, 222, 138);")
