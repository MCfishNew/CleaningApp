...
################################################################################
## Form generated from reading UI file 'ConfirmDelUserDialogRCuLnH.ui'
##
...
class Ui_ConfirmDelUserDialog(object):
    def setupUi(self, ConfirmDelUserDialog):
        ...
        ConfirmDelUserDialog.setStyleSheet(u"")
        ...
        self.confirm_button.setStyleSheet(u"background-color: rgb(153, 255, 165);")
        ...
        self.cancel_button.setStyleSheet(u"background-color: rgb(255, 130, 130);")
