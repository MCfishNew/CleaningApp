...
################################################################################
## Form generated from reading UI file 'AutorizationDialogOMUpZw.ui'
##
...
class Ui_AutorizationDiolog(object):
    def setupUi(self, AutorizationDiolog):
        ...
        AutorizationDiolog.resize(179, 261)
        ...
        self.login_button.setStyleSheet(u"background-color: rgb(122, 170, 128);")
